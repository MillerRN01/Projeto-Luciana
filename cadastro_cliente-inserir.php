...
<div class="container">
    ...
    // Executar a consulta
    $query = "SELECT nome FROM cliente WHERE nome LIKE '%$nome%'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<form method='post' action='____.php'>";
        echo "<div class='mb-3'>";
        echo "<label for='cliente' class='form-label'>Escolha um cliente:</label>";
        echo "<select name='cliente' id='cliente' class='form-select'>";
        ...
        echo "<input type='number' class='form-control' placeholder='Digite a quantidade de Produtos' name='quantidade' required>";
        echo "</div>";
        //tabela valor dos preços//
        echo "<div class='mb-3'>";
        echo "<label for='valor_produto' class='form-label'>Valor Total</label>";
        echo "<input type='number' class='form-control' placeholder='Digite o valor total dos Produtos' name='valor_produto' required>";
        echo "</div>";
        //tabela data//
        echo "<div class='mb-3'>";
        echo "<label for='data_entrega' class='form-label'>Data da Venda</label>";
        echo "<input type='date' class='form-control' placeholder='Digite a data da Venda' name='data_venda' required>";
        echo "</div>";
        //tabela butão//
